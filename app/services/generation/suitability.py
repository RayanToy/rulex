...
термины, — и то, чему не место в школьном тесте: бранную лексику
(в список для 5 класса попало «материть»). Сбой модели означает «не годится»: лучше не пустить слово
...
- Грубое, бранное или неприличное слово
